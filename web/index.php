...
<?php
if ( isset($_POST['pass']) & isset($_POST['name']) & @MD5($_POST['pass'])=="21232f297a57a5a743894a0e4a801fc3" & @$_POST['name']=="admin" )
	//假如在内网就不用改,开放到外网就需要改动. 21232f297a57a5a743894a0e4a801fc3为admin的md5值,修改这个就是修改密码
{
?>
<body bgcolor="#110f13">

<iframe id="frm1" name="frm"src="http://127.0.0.1:57575/" width="677" height="650" scrolling="yes" frameborder="0"></iframe>
<!--一般不需要修改这个,除非你的57575被占用 ,http://127.0.0.1:57575/ 这个地址是运行start.sh后输出的地址-->
<iframe id="frm2" name="frm"src="includeme.php" width="557" height="650" scrolling="no" frameborder="0"></iframe>
<!--这个一般不需修改 除非该文件和includeme.php不在一个目录下-->
<?php
}else{
?>
	<body id="home">
			...
			<div class="border start">
				<form method="post" action="index.php">
					...
					<input name="pass" type="password" placeholder="Pass"/>
                                        <input type="submit" value="GSMSniffer ::L Team::"/>
				</form>
			</div>
		</div>
	</body>
